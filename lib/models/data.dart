...
final User user_1 = User(
    name: const Name(first: 'Old', last: 'Strong'),
...
final List<Email> emails = [
  Email(
    ...
    recipients: [],
    subject: 'Tofu Fish',
    content: 'Have you been busy recently? Last night I went to your favorite restaurant, ordered their special Tofu Fish, and I missed you while eating.',
  ),
  Email(
    sender: user_2,
    recipients: [],
